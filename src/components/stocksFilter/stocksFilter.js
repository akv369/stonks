                            ...
                            <Form.Row>
                                ...
                                <Form.Group>
                                    <Form.Control
                                        ...
                                        onChange={(event)=>this.setState({mcLl:event.target.value})}
                                    />
                                </Form.Group>
                                </Col>
                                <Col md={1}>_</Col>
                                ...
                                <Form.Group>
                                    <Form.Control
                                        ...
                                        onChange={(event)=>this.setState({mcUl:event.target.value})}
                                    />
                                </Form.Group>
                                </Col>
                            </Form.Row>
                            ...
                            <Form.Row>
                                ...
                                <Form.Group>
                                    <Form.Control
                                        ...
                                        onChange={(event)=>this.setState({cmpLl:event.target.value})}
                                    />
                                </Form.Group>
                                </Col>
                                <Col md={1}>_</Col>
                                ...
                                <Form.Group>
                                    <Form.Control
                                        ...
                                        onChange={(event)=>this.setState({cmpUl:event.target.value})}
                                    />
                                </Form.Group>
                                </Col>
                            </Form.Row>
